...
export default function YiyuanhugongPage({ serviceItems }) {
  // 使用动态获取的服务项目，如果没有则回退到配置文件
  const service = {
    ...SERVICE_CONTENT.yiyuanhugong,
    services: serviceItems && serviceItems.length > 0 ? serviceItems : SERVICE_CONTENT.yiyuanhugong.services
  }
